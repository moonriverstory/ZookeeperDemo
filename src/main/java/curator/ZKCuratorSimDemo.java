...
public class ZKCuratorSimDemo {

    private static final Logger LOGGER = LoggerFactory.getLogger(ZKCuratorSimDemo.class);
    ...
    public static void demoProcess1() throws Exception {
        CuratorFramework client = ZKCuratorSimDemo.getRunningConnect(CONNECTION_URL);
